...
namespace CreatureClimb
{
    ...
    public class CustomizeMenu : MonoBehaviour
    {
        ...
        void ApplyCustomizeTextStyles()
        {
            ...
            if (closeButton != null)
                UiTextStyle.StyleMenuButton(closeButton);

            if (selectionLabel != null)
                UiTextStyle.ApplySized(selectionLabel, UiTextStyle.MenuFontSize, TextAnchor.MiddleCenter);
            if (titleText != null)
        ...
        public void Open(Tab tab = Tab.Characters)
        {
            ...
            ApplyCustomizeTextStyles();
            ShowTab(tab);
            // Force pure white + black after any tab rebuild.
            if (root != null)
                UiTextStyle.ApplyAllUnder(root.transform);
        ...
        {
            // Keep the three tabs a bit lower under the title.
            if (root == null) return;
        ...
        void RefreshTabStyles()
        {
            ...
            if (subtitleText != null)
            {
                subtitleText.text = currentTab switch
                {
                    ...
                    Tab.Platforms => "Solid look · hover to preview break",
                    _ => "Pick your stage backdrop"
                };
                UiTextStyle.Apply(subtitleText);
            }
        }
        ...
        static void StyleTab(Button tab, bool active)
        {
            ...
            if (label != null)
            {
                // Show "Stage" even if the button was built as "Backgrounds".
        ...
        void BuildPlatforms(GameManager gm)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                var index = i;
                // Solid only in the grid — break sprite is hover-only (not a separate entry).
        ...
        void BuildBackgrounds(GameManager gm)
        {
        ...
        void UpdateSelectionLabel(GameManager gm)
        {
            ...
            UiTextStyle.ApplySized(selectionLabel, UiTextStyle.MenuFontSize);
        }
