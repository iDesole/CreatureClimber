...
namespace CreatureClimb
{
    ...
    public class Creature
    {
        ...
        [Tooltip("Silly racer handle used in Race mode (e.g. CLUCKY). Shown when this creature is the AI.")]
        public string raceNickname = "";
        ...
        /// <summary>Race-mode handle; falls back to a built-in silly default if left blank.</summary>
        public string RaceNickname =>
            string.IsNullOrWhiteSpace(raceNickname)
                ? RaceNicknames.DefaultForId(Id, DisplayName)
                : raceNickname.Trim();
