...
namespace CreatureClimb
{
    ...
    public class Background
    {
        ...
        [Tooltip("Optional second parallax layer (trees, clouds). Leave empty for single layer.")]
        public Sprite nearSprite;

        public Color nearTint = Color.white;

        [Range(0f, 1f)]
        public float nearParallax = 0.35f;

        [Tooltip("Camera clear color while this band is in view (alpha ignored).")]
        public Color skyColor = new Color(0.14f, 0.3f, 0.18f, 1f);
        ...
        public Sprite ResolveSprite()
        {
            ...
            return PixelSpriteFactory.CreateSolid(8, 8, skyColor.a > 0.01f ? skyColor : new Color(0.12f, 0.28f, 0.16f));
        }
